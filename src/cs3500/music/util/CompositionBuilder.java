...
/**
 * A builder of compositions.  Since we do not know in advance what the name of the main
 * type is for a model, we parameterize this builder interface by an unknown type.
 *
...
public interface CompositionBuilder<T> {
   ...
   * @param pitch      The pitch (in the range [0, 127], where 60 represents C4, the
   *                   middle-C on a piano)
